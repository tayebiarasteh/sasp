...
% Last Modified by GUIDE v2.5 26-Jun-2020 14:19:54
...
if handles.Active_trainTS1
	...
	while notFinished
		try
            ...
            handles.disp_A1.Position([1,2]) = [0.15 , 0.25];
            handles.disp_A1.Position([3,4]) = [0.55 , 0.2 ]; 
            
            handles.disp_pi1.Position([1,2]) = [0.15 , 0.1]
            handles.disp_pi1.Position([3,4]) = [0.55 , 0.1 ]; 
...
if handles.Active_trainTS2
	...
	while notFinished
		try
            ...
            handles.disp_A2.Position([1,2]) = [0.15 , 0.25];
            handles.disp_A2.Position([3,4]) = [0.55 , 0.2 ]; 
            
            handles.disp_pi2.Position([1,2]) = [0.15 , 0.1]
            handles.disp_pi2.Position([3,4]) = [0.55 , 0.1 ]; 
